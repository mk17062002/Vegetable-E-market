...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/img/logo.png" />
    <title>VEGETABLE E-MARKET</title>
    ...
    >
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <a class="nav-link dropdown-toggle text-white " role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"
        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">VEGETABLE E-MARKET</h1>
              <p class="text-white">
...
const apiKey = "AIzaSyAAi1gj6BqAB96_gX-BoKPqe7Mg3mRJgWI";   // Enter your apikey here
