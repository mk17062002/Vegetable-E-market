...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 24, 2024 at 09:38 AM
...
(6, 'monishkumar', '7598512950', 'monishku6@gmail.com', 'vellore', 'its working');
...
INSERT INTO `custlogin` (`cust_id`, `cust_name`, `password`, `email`, `address`, `city`, `pincode`, `state`, `phone_no`) VALUES
(1, 'customer', 'password', 'customer@gmail.com', 'vallimalai', 'vellore', '632520', 'tamilnadu', '9360063378\r\n');
...
CREATE TABLE IF NOT EXISTS `district` (
  `DistCode` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `farmerlogin` (`farmer_id`, `farmer_name`, `password`, `email`, `phone_no`, `F_gender`, `F_birthday`, `F_State`, `F_District`, `F_Location`) VALUES
(17, 'Monish', 'password', 'monishku6@gmail.com', '7598512950', 'male', '17-06-2002', 'tamilnadu', 'vellore', 'ponnai');
...
(108, 17, 'Bitter Ground', 20, 23, 35),
(111, 17, 'Beans', 20, 65, 98),
(112, 17, 'Beetroot', 20, 45, 68),
(113, 17, 'Big Onion', 20, 45, 68),
(114, 17, 'Bottle Gourd', 20, 40, 83),
(115, 17, 'Brinjal', 20, 45, 68),
(116, 17, 'Cabbage', 20, 40, 60),
(117, 17, 'Capsicum', 20, 60, 90),
(118, 17, 'Carrot', 20, 55, 83),
(119, 17, 'Cauliflower', 20, 30, 45),
(120, 17, 'Chow Chow', 20, 18, 27),
(121, 17, 'Coriander', 20, 30, 45),
(122, 17, 'Cucumber', 20, 30, 45),
(123, 17, 'Curry Leaves', 20, 60, 90),
(124, 17, 'Garlic', 20, 60, 90),
(125, 17, 'Ginger', 20, 50, 75),
(126, 17, 'Green Chilly', 20, 100, 113),
(127, 17, 'Mint', 20, 70, 105),
(128, 17, 'Moringai Leaves', 20, 50, 75),
(129, 17, 'Moringakai', 20, 40, 60),
(130, 17, 'Potato', 20, 18, 27),
(131, 17, 'Pumkin', 20, 50, 75),
(132, 17, 'Radish', 20, 50, 75),
(133, 17, 'Ridge Gourd', 20, 50, 75),
(134, 17, 'Small Onion', 20, 30, 45),
(135, 17, 'Tomato', 20, 30, 45),
(136, 17, 'Yam', 30, 80, 120),
(137, 17, 'Cucumber', 20, 30, 45),
(138, 17, 'Tomato', 50, 30, 45),
(139, 17, 'Green Chilly', 100, 50, 113),
(140, 17, 'Bottle Gourd', 100, 70, 83);
...
CREATE TABLE IF NOT EXISTS `farmer_history` (
  ...
  `farmer_quantity` int NOT NULL,
  `farmer_price` int NOT NULL,
...
(25, 17, 'bajra', 1, 23, '01/04/2023'),
(28, 17, 'arhar', 1, 60, '03/04/2023'),
(30, 17, 'barley', 1, 2, '03/04/2023');
...
CREATE TABLE IF NOT EXISTS `state` (
  `StCode` int NOT NULL AUTO_INCREMENT,
