...
<input hidden name="tradeid" id="tradeid"  value="">
						...
						<td>   
						  <div class="form-group">     
							<input id="quantity" type="number" placeholder="Available Quantity" min="1" max="9999" name="quantity" required class="form-control text-dark">   
						  </div> 
						</td>
